...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[@id=\"root\"]/div/div/div[3]/div[2]/div/div/div[not(contains(text(),'Order')) and not(contains(text(),'$'))]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("div[2]")).getText().split("\n")[0]);
            }
